...
func _build_ui() -> void:
	...
	title.font_scale =  20)
	title	title	title	add_child(title)
	...
	content.font_scale =  13)
	content	add_child(content)
	
	# Close button
	var close_btn := Button.new()
	close_btn.name = "CloseBtn"
	close_btn.label_text = "Close"
